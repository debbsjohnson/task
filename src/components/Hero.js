...
function Hero() {
  ...
  return (
    ...
    <div className="container mx-auto h-full relative font-primary">
        <div className='flex flex-col xl:flex-row items-center h-full md:py-24'>
           {/* Text */}
           <div className='text-center xl:text-left xl:absolute'>
              <h1 className="font-primary xl:max-w-[700px] sm:max-w-[400px] mb-4 text-[#474545] text-6xl font-semibold leading-15" data-aos='fade-down' data-aos-delay='400'>#1 Super app for <br></br>all <span className='text-[#8028FF] text-[50px] font-semibold'> home services</span> </h1>
              <div className='flex flex-row xl:max-w-[380px]' data-aos='fade-down' data-aos-delay='500'>
                    <p className='font-fontFamily:primary text-[#474545] text-[15px] font-normal'>We deliver home services in one click in</p>
              ...
              <div className='flex flex-row mt-12 mb-8 xl:mb-0' data-aos='fade-down' data-aos-delay='600'>
    ...
    <div className='flex flex-col sm:mt-20 mb-96 mx-auto'>
